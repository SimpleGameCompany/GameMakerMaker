...
Shader "Legacy Shaders/Self-Illumin/Bumped Specular Emision Count" {
Properties {
...
void surf (Input IN, inout SurfaceOutput o) {
    ...
    fixed4 c = tex * _Color;
    o.Albedo = c.rgb;
    o.Emission = c.rgb * tex2D(_Illum, IN.uv_Illum).a * _EmisionMultiplier;
